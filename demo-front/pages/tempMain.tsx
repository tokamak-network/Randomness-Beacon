...
export default function TempMain() {
    ...
    async function updateUI() {
        ...
        setRegistrationDurationForNextRound(registrationDurationForNextRoundFromCall?.toString())
        const hours = Math.floor(
            parseInt(registrationDurationForNextRoundFromCall?.toString()) / 3600
        )
        const minutes = Math.floor(
            (parseInt(registrationDurationForNextRoundFromCall?.toString()) - hours * 3600) / 60
        )
        const seconds =
        ...
        setStartRegistrationTimeForNextRound(startRegistrationTimeForNextRoundFromCall.toString())
